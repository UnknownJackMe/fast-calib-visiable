...
Params loadParameters(rclcpp::Node::SharedPtr node)
{
  ...
  node->declare_parameter("cluster_tolerance", 0.02);
  node->declare_parameter("cluster_min_size", 50);
  node->declare_parameter("cluster_max_size", 1000);
  node->declare_parameter("aruco_dictionary", string("DICT_6X6_250"));
  node->declare_parameter("aruco_ids", vector<int64_t>{1, 2, 4, 3});
  ...
  node->get_parameter_or("cluster_tolerance", params.cluster_tolerance, 0.02);
  node->get_parameter_or("cluster_min_size", params.cluster_min_size, 50);
  node->get_parameter_or("cluster_max_size", params.cluster_max_size, 1000);
  node->get_parameter_or("aruco_dictionary", params.aruco_dictionary, string("DICT_6X6_250"));
  node->get_parameter_or("aruco_ids", params.aruco_ids, vector<int64_t>{1, 2, 4, 3});
